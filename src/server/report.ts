...
export function renderHtml(m: ReportModel): string {
  ...
  <div class="slide">
    ...
    <div class="foot">Generated by Financial Analysis Pipeline · ${escapeHtml(m.id)}</div>
  </div>`;
...
function drawDeck(doc: PDFKit.PDFDocument, m: ReportModel): void {
  ...
  slide('Methodology & Appendix', () => {
    ...
    doc.fillColor('#64748b').fontSize(9).text(`Generated by Financial Analysis Pipeline · ${m.id}`, { width: W });
  });
}
