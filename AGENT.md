...
- `docs/ARCHITECTURE.md §Multi-Source Data Architecture` — vendor-agnostic multi-source plan (data domains + adapters + fan-in/weighting; phased rework NOT yet scheduled).
